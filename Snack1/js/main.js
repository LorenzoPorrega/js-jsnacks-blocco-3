...
*/
while (sum <= 50){
    const numToInsert = parseInt(prompt("Write down one number to add to the array, this input request will be itirated until the sum of the user given numbers is less than 50"));
